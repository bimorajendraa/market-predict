...
-- ============================================
-- Table: idx_filings
-- Metadata filing IDX / Investor Relations (Indonesia)
-- ============================================
CREATE TABLE IF NOT EXISTS idx_filings (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    ticker VARCHAR(20) NOT NULL,
    source VARCHAR(30) NOT NULL DEFAULT 'idx_ir', -- idx_ir, ir_site, earnings_pr
    filing_type VARCHAR(50) NOT NULL,             -- quarterly_report, annual_report, earnings_release
    filing_date DATE,
    period VARCHAR(20),
    url TEXT NOT NULL,
    checksum VARCHAR(64),
    doc_kind VARCHAR(50),                         -- pdf/html/press_release
    title TEXT,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    UNIQUE (ticker, url)
);
...
-- Structured quarterly/annual fundamentals with unit metadata
-- ============================================
...
-- Dividend, split, reverse split, rights issue, share count history
-- ============================================
CREATE TABLE IF NOT EXISTS corporate_actions (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    ticker VARCHAR(20) NOT NULL,
    action_date DATE NOT NULL,
    action_type VARCHAR(30) NOT NULL, -- dividend, split, reverse_split, rights_issue, share_count
    amount DECIMAL(30, 8),
    currency VARCHAR(10),
    ratio VARCHAR(30),
    shares_outstanding DECIMAL(30, 4),
